...
//	loot = list(/obj/effect/gibspawner/human, /obj/item/stack/f13Cash/random/bottle_cap/low)   // not quite ready for cap drops on ghouls
	...
	taunt_chance = 30
	aggrosound = list('sound/f13npc/ghoul/taunt.ogg')
...
/mob/living/simple_animal/hostile/ghoul/tuskan/manic
	name = "Tuskan hunter"
	desc = "A Tuskan raider, armed with a primitive blaster rifle. Strange...until recently, they always carried cycler rifles."
	icon = 'icons/mob/wastemobs.dmi'
	icon_state = "tuskanexile"
	icon_living = "tuskanexile"
	icon_dead = "tuskanexile_d"
	icon_gib = "gib"
	speak_chance = 0
	turns_per_move = 25
	environment_smash = 0
	...
	loot = list(/obj/item/gun/energy/laser/tuskenblaster)
	projectiletype = /obj/item/projectile/beam/laser/Repeater
	projectilesound = 'sound/weapons/blasters/repeater.ogg'
	faction = list("ghoul", "hostile")
	melee_damage_lower = 15
	melee_damage_upper = 20
	aggro_vision_range = 10
	attacktext = "shoots"
	attack_sound = "punch"
	emote_taunt_sound = list('sound/f13npc/ghoul/Tuskenidle.ogg')
	emote_taunt = list("gurgles", "stares")
	taunt_chance = 30
	aggrosound = list('sound/f13npc/ghoul/tuskenaggro.ogg')
	idlesound = list('sound/f13npc/ghoul/Tuskenidle.ogg')
	death_sound = 'sound/f13npc/ghoul/ghoul_death.ogg'

/mob/living/simple_animal/hostile/ghoul/tuskan/youth
	name = "Tuskan Youth"
	desc = "A young Tuskan raider, armed with a gaffi stick. He seems eager to prove himself to his tribe."
	icon = 'icons/mob/wastemobs.dmi'
	icon_state = "tuskanyouth"
	icon_living = "tuskanyouth"
	icon_dead = "tuskanyouth_d"
	mob_biotypes = list(MOB_ORGANIC, MOB_HUMANOID)
	robust_searching = 1
	turns_per_move = 3
	speak_emote = list("growls")
...
//	loot = list(/obj/effect/gibspawner/human)   // not quite ready for cap drops on ghouls
...
/mob/living/simple_animal/hostile/ghoul/tuskan/brave
	name = "Tuskan Brave"
	desc = "An experienced Tuskan raider, his coat is made of fragments of Protocol droid plating, loosely fitted together."
	icon = 'icons/mob/wastemobs.dmi'
	icon_state = "tuskanbrave"
	icon_living = "tuskanbrave"
	icon_dead = "tuskanbrave_d"
	mob_biotypes = list(MOB_ORGANIC, MOB_HUMANOID)
	robust_searching = 1
	turns_per_move = 3
	speak_emote = list("growls")
...
/mob/living/simple_animal/hostile/ghoul/tuskan/warchief
	name = "Tuskan Warchief"
	desc = "Wearing metal armour and wielding a sharp cleaver, this Warchiefs stray from tradition is testament to the innovations of the visionary Warlord."
	icon = 'icons/mob/wastemobs.dmi'
	icon_state = "tuskanwarchief"
	icon_living = "tuskanwarchief"
	icon_dead = "tuskanwarchief_d"
	mob_biotypes = list(MOB_ORGANIC, MOB_HUMANOID)
	robust_searching = 1
	turns_per_move = 3
	speak_emote = list("growls")
...
//	loot = list(/obj/effect/gibspawner/human,   // not quite ready for cap drops on ghouls
	...
	emote_taunt = list("gurgles", "stares")
	taunt_chance = 30
	aggrosound = list('sound/f13npc/ghoul/Tuskenidle.ogg')
	idlesound = list('sound/f13npc/ghoul/Tuskenidle.ogg')
	death_sound = 'sound/f13npc/ghoul/ghoul_death.ogg'
