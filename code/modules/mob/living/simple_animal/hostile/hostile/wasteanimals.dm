...
/mob/living/simple_animal/hostile/dwarfacklay
	name = "Dwarf Acklay"
	desc = "Adapted for the shallow waterbeds on Mortooine, these Acklays have undergone dwarfism."
	...
	speak_chance = 0
	turns_per_move = 2
	butcher_results = list(/obj/item/stack/sheet/sinew = 2, /obj/item/stack/sheet/animalhide/chitin = 3)
	response_help = "pets"
	response_disarm = "gently pushes aside"
	response_harm = "hits"
