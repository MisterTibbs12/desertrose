...
/mob/living/simple_animal/hostile/handy/Tombguard
	name = "Tomb Guard"
	desc = "An ancient battle droid, it has stood watch over this hallowed ground for aeons."
	icon_state = "Tombguard"
	icon_living = "Tombguard"
	icon_dead = "Tombguard_d"
	health = 280
	maxHealth = 280
	melee_damage_lower = 48
	melee_damage_upper = 72
	extra_projectiles = 2 //5 projectiles
	ranged_cooldown_time = 6 //brrrrrrrrrrrrt
	stat_attack = UNCONSCIOUS
	ranged = TRUE
	retreat_distance = 2
	minimum_distance = 2
	del_on_death = FALSE
	attacktext = "pulverizes"
	attack_sound = 'sound/weapons/melee/slash.ogg'
	projectilesound = 'sound/weapons/blasters/Repeater.ogg'
	projectiletype = /obj/item/projectile/beam/laser/pistol/ultraweak
	faction = list("wastebot")
	check_friendly_fire = TRUE
	loot = list(/obj/effect/decal/cleanable/robot_debris, /obj/item/stack/crafting/electronicparts/five, /obj/item/stock_parts/cell/ammo/mfc)
	...
	emote_taunt_sound = list('sound/f13npc/Tombguard/Emote-1.ogg', 'sound/f13npc/Tombguard/Emote-2.ogg')
	emote_taunt = list("spins its barrels")

	aggrosound = list('sound/f13npc/Tombguard/Emote-2.ogg')
	idlesound = list('sound/f13npc/Tombguard/Emote-1.ogg', 'sound/f13npc/Tombguard/Emote-2.ogg')


/mob/living/simple_animal/hostile/handy/Darkguard
	name = "Dark Guard"
	desc = "The air around it feels cold,and your head hurts to look at it. Best keep a distance."
	icon_state = "Darkguard"
	icon_living = "Darkguard"
	icon_dead = "Darkguard_d"
	health = 360
	maxHealth = 360
	melee_damage_lower = 40
	melee_damage_upper = 63
	extra_projectiles = 2 //5 projectiles
...
/mob/living/simple_animal/hostile/b1stabber
	name = "B1 Battledroid"
	desc = "A B1 armed with a vibroblade, quite capable of closing the distance and slashing through you."
	icon = 'icons/mob/robots.dmi'
	icon_state = "stabberb1"
	icon_living = "stabberb1"
	icon_dead = "gib7"
	gender = NEUTER
	mob_biotypes = list(MOB_ROBOTIC)
	anchored = TRUE //unpullable
	...
	healable = 0
	speed = 3
	melee_damage_lower = 34 //halved this on req
	melee_damage_upper = 34 //as above
	attacktext = "saws"
	faction = list("wastebot")
	atmos_requirements = list("min_oxy" = 0, "max_oxy" = 0, "min_tox" = 0, "max_tox" = 0, "min_co2" = 0, "max_co2" = 0, "min_n2" = 0, "max_n2" = 0)
	minbodytemp = 0
	...
	emote_taunt = list("raises their knife")
	attack_sound = 'sound/weapons/melee/slash.ogg'

	damage_coeff = list(BRUTE = 1, BURN = 1, TOX = 0, CLONE = 0, STAMINA = 0, OXY = 0)

/mob/living/simple_animal/hostile/b1blaster
	name = "B1 Battledroid"
	desc = "A Clone-wars era Battledroid, old and somewhat fragile, but nevertheless armed."
	icon = 'icons/mob/robots.dmi'
	icon_state = "blasterb1"
	icon_living = "blasterb1"
	icon_dead = "gibs3"
	health = 120
	maxHealth = 120
	speed = 2
	...
	attack_sound = 'sound/weapons/punch1.ogg'
	projectilesound = 'sound/weapons/blasters/Repeater.ogg'
	projectiletype = /obj/item/projectile/beam/laser/Imperial
	faction = list("wastebot")
	check_friendly_fire = TRUE
	loot = list(/obj/effect/decal/cleanable/robot_debris, /obj/item/stack/crafting/electronicparts/five)
	emote_taunt = list("raises a laser")

	aggrosound = list('sound/f13npc/B1/activated.ogg')

/mob/living/simple_animal/hostile/tridroid
	name = "Octuptarra tri-doid"
	desc = "A massive behemoth of a droid, ."
	icon = 'icons/mecha/mechswbig.dmi'
	icon_state = "octuptarra"
	icon_living = "octuptarra"
	icon_dead = "octuptarra_d"
	health = 2000
	maxHealth = 2000
	speed = 1
	melee_damage_lower = 5 //severely reduced melee damage here because its silly to have a ranged mob also be a cqc master
	...
	attacktext = "stomps"
	attack_sound = 'sound/weapons/punch1.ogg'
	projectilesound = 'sound/weapons/blasters/Heavycannon.ogg'
	projectiletype = /obj/item/projectile/beam/laser/Explosive
	faction = list("wastebot")
	check_friendly_fire = TRUE
	loot = list(/obj/effect/decal/cleanable/robot_debris, /obj/item/stack/crafting/electronicparts/five)

	aggrosound = list('sound/f13npc/Tombguard/Emote-1.ogg')
